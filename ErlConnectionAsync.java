...
public class ErlConnection {
     ...
     private BlockingQueue<ClientFunctionTuple> serverCalls;
      ...
      public ErlConnection(String _peer, String _cookie, BlockingQueue<ClientFunctionTuple> _serverCalls;) {
     ...
     public void clientFunction(String function, OtpErlangObject[] args){
        ClientFunctionTuple tuple = new ClientFunctionTuple(function, args);
        serverCalls.put(tuple);
     }
     private void clientFunctionAsync(String function){
     ...
     public GameBoard clientFunctionAsync(String function, OtpErlangObject[] args){
        GameBoard board;
     ...
     private GameBoard parseResponse(){
      //BEGIN WORK HERE
     }
